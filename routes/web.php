...
use App\Http\Controllers\Mfa\EmailOtpController;
...
Route::get('/register/email-otp', [EmailOtpVerificationController::class, 'show'])->name('register.email-otp.show');
Route::post('/register/email-otp', [EmailOtpVerificationController::class, 'verify'])->name('register.email-otp.verify');
Route::post('/register/email-otp/resend', [EmailOtpVerificationController::class, 'resend'])->middleware('throttle:email-resend')->name('register.email-otp.resend');
...
Route::get('/mfa/email-otp', [EmailOtpController::class, 'show'])->middleware('throttle:email-resend')->name('email-otp.show');
Route::post('/mfa/email-otp', [EmailOtpController::class, 'verify'])->middleware('throttle:totp')->name('email-otp.verify');
Route::post('/mfa/email-otp/resend', [EmailOtpController::class, 'resend'])->middleware('throttle:email-resend')->name('email-otp.resend');
